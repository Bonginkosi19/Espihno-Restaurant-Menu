  ...
  return (
    <header
      className={`fixed top-0 inset-x-0 z-40 transition-all duration-300 ${
        scrolled ? 'bg-black/95 backdrop-blur-xl shadow-xl shadow-amber-500/10 py-3' : 'bg-black/30 backdrop-blur-md py-5'
      }`}
    >
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between gap-4">
        <Link to="/" className="flex items-center gap-3 focus:outline-none">
          ...
          <div className="hidden sm:block leading-tight">
            <p className="text-amber-400/90 text-[10px] uppercase tracking-[0.3em] font-light">Restaurant & Bar</p>
        ...
        <nav className="hidden md:flex items-center gap-1">
          ...
          <button
            ...
            className="ml-3 px-5 py-2 rounded-full border border-amber-400 text-amber-400 hover:bg-amber-400 hover:text-black text-xs uppercase tracking-[0.25em] font-semibold transition-all focus:outline-none focus:ring-2 focus:ring-amber-400/60"
          >
            Reserve
          </button>
        </nav>
        ...
        <button
          ...
          className="md:hidden text-amber-400 p-2 rounded-md hover:bg-amber-400/10 focus:outline-none focus:ring-2 focus:ring-amber-400/60"
        >
